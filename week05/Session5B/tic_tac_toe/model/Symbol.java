...
public enum Symbol {
    X("week05/Session5B/tic_tac_toe/media/img/troll.jpg","week05/Session5B/tic_tac_toe/media/sound/roar.wav",GameState.TROLL_WIN),
    O("week05/Session5B/tic_tac_toe/media/img/goat.jpeg","week05/Session5B/tic_tac_toe/media/sound/bleat.wav",GameState.GOAT_WIN),
    N();
